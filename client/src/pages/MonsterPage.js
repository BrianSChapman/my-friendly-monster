  ...
  return (
    <div>
      <section className="container-fluid d-flex justify-content-around">
        <div className="monster-with-biome">
          <img
            src={`${getBiome()}`}
            alt="biome background"
            className="biome-background container-fluid d-flex justify-content-center"
          />
          <img src={`${newMonster()}`} alt="monster pixel art" className="monster-on-monster-page"/>
        </div>
